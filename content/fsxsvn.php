...
<h1 id="MODULE_FSXSVN">FSx-Connector <span class="color_h1">Versiones y Control de Cambios</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="index.php?tab=fsxfaq">&laquo; Anterior</a></div>
<div class="next"><a class="chapter" href="index.php?tab=fsxdev">Siguiente &raquo;</a></div>
</div>
<hr>

<h2>FSx-Connector V3.0.17 - <2013-06-14> (ESTABLE MS-1)</h2>
<p><img width="16" height="16" src="images/loyalty.gif" alt="loyalty"> 
Es la primera versión estable de FSx-Connector para PrestaShop 1.5.x, y no soporta multi-tienda. 
Contiene todas las funciones de la versión BETA anterior, pero con calidad y estabilidad adecuadas para uso en producción.</p>
<hr>

<h2>FSx-Connector V3.0.0 - <2013-03-19> (BETA)</h2>
<p>Es la primera versión de FSx-Connector para PrestaShop 1.5.x, y no soporta multi-tienda. Respecto a versiones anteriores, se ha reescrito la mayor parte del Código para adaptarlo a la nueva arquitectura de PrestaShop.</p>
<p>Se conservan las funcionalidades de versiones anteriores, pero se incluyen mejoras sustanciales:</p>
<ul>
	<li>Se han mejorado los Manuales de Ayuda, y se integran con FSx-Connector. Esto significa que cuando usa FSx-Connector puede obtener directamente ayuda sensible al contexto.<br><br></li>
	<li>Se han ampliado los controles y validaciones, de forma que se evitan los errores antes de que sucedan, informando al usuario de los pasos que faltan, o de las acciones que debe realizar a continuación.<br><br></li>
	<li>En esta Versión ya no es necesario modificar ficheros de PrestaShop 1.5.x, ya que se utiliza el mecanismo estándar de Sobrecarga (Override) de Clases y Controladores de PrestaShop.<br><br></li>
	<li>Se añade una función para informar de errores al Equipo de Desarrollo.<br><br></li>
	<li>Se añade una función para comprobar si está usando la última versión de FSx-Connector.<br><br></li>
	<li>Componente FSx-Configuración.<br>
	Mejora guiada de las Opciones de Configuración de FSx-Connector y de FactuSOL. Informa de las opciones relevantes de FactuSOL.<br><br></li>
	<li>Componente FSx-Diccionario.<br>
	Se muestran los Porcentajes de Impuestos provenientes de FactuSOL. Se ha mejorado el interface del Mapa de Categorías, con tecnología Ajax basada en jQuery.<br><br></li>
	<li>Componente FSx-Catálogo.<br>
	La comprobación del Diccionario de categorías es ahora opcional en este componente (se traslada al Componente FSx-Diccionario). Se controla el Tiempo de Ejecución para evitar timeout, y si sucede, puede continuar automáticamente.<br><br></li>
	<li>Componente FSx-Pedidos.<br>
	Mejora la información que se da al usuario para gestionar la descarga de Pedidos.<br><br></li>
	<li>Componente FSx-LOG.<br>
	Se ha mejorado el filtrado de mensajes. Se puede exportar el contenido del LOG en formato CSV para manejarlo en una Hoja de Cálculo.<br><br></li>
</ul>
<!-- p>
<img width="16" height="16" src="images/loyalty.gif" alt="loyalty"> 
<b>Nota:</b>
Esta versión está en desarrollo (BETA) y aún no es apta para entornos de producción.
</p -->
<hr>
...
<table class="lamp" id="table1">
	<tr>
		...
		<td><b>¿Cuál será el Código de Cliente en FactuSOL?<br><br></b>
