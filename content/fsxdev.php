...
<h1 id="MODULE_FSXDEV">FSx-Connector <span class="color_h1">Desarrollo</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="index.php?tab=fsxsvn">&laquo; Anterior</a></div>
<!-- div class="next"><a class="chapter" href="index.php?tab=fsx">Siguiente &raquo;</a></div -->
</div>
<hr>
<p class="intro">Aquí podrá encontrar las funcionalidades que incorporaremos a FSx-Connector.</p>

<p>Si tiene alguna sugerencia concreta para que podamos mejorar FSx-Connector, por favor, <a href="" onclick="displayError();return false">indíquenoslo aquí</a>.</p>
<hr>

<h2>FSx-Connector V3.0 MS-1</h2>
<ul>
	<li>Importar Tarifas de FactuSOL y asignarlas a Grupos de Clientes de PrestaShop.</li>
</ul>
<hr>

<h2>FSx-Connector V3.0 MS-2</h2>
<ul>
	<li>Tratamiento básico de Productos con Combinaciones.</li>
</ul>
<hr>

<h2>FSx-Connector V3.0 MS-3</h2>
<ul>
	<li>Instalador automático: el módulo se podrá descargar desde el sitio de FSx-Connector durante la instalación desde el Back Office de PrestaShop.</li>
	<li>Actualización automática: los usuarios registrados podrán descargar desde el sitio de FSx-Connector la última versión e instalarla automáticamente.</li>
</ul>
<hr>

<h2>FSx-Connector V3.0 MS-4</h2>
<ul>
	<li>Compatibilidad PrestaShop multi-tienda.</li>
</ul>
<hr>

<h2>FSx-Connector V3.0 MS-5</h2>
<ul>
	<li>Compatibilidad PrestaShop Gestión Avanzada de Stock (¿?).</li>
</ul>
<hr>
