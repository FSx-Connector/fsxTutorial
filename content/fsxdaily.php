...
<h1 id="MODULE_FSXDAILY">FSx-Connector <span class="color_h1">Esquema General</span></h1>
<div class="chapter">
<div class="prev"><a class="chapter" href="index.php?tab=fsxinstall">&laquo; Anterior</a></div>
<div class="next"><a class="chapter" href="index.php?tab=fsxfsol">Siguiente &raquo;</a></div>
</div>
<hr>

<p class="intro">En este capítulo se describen de forma resumida los pasos para la puesta en marcha
de FSx-Connector, y la secuencia normal de trabajo.</p>
<hr>

<img src="images/fsxdaily_esquema.png" alt="fsxdaily_esquema">
<p>&nbsp;</p>
<style type="text/css">

    ol.stepone, ol.steptwo, ol.stepthree { counter-reset: item; }

    ol.stepone li, ol.steptwo li, ol.stepthree li { display: block; }

    ol.stepone li:before { content: "1."counter(item) ; counter-increment: item; 
        display: inline-block; width: 2.5em; }
    ol.steptwo li:before { content: "2."counter(item) ; counter-increment: item; 
        display: inline-block; width: 2.5em; }
    ol.stepthree li:before { content: "3."counter(item) ; counter-increment: item; 
        display: inline-block; width: 2.5em; }

</style>
<ol>
	<li>En <b>FactuSOL</b>:<br><br>
		<ol class="stepone">
			<li><b>Preparar FactuSOL.</b><br>
				Configurar la conexión a Internet (&quot;Internet -> Configuración -> Configuraciones Técnicas&quot;).<br><br></li>
			<li><b>Filtrar los Datos que se subirán a Internet.</b><br>
				Establecer qué Secciones, Familias, Artículos y Formas de Pago estarán
				disponibles en Internet. La forma más sencilla es activando el uso en Internet en los datos de cada elemento.<br><br></li>
			<li><b>Subida Genérica de Datos a Internet.</b><br>
				En &quot;Internet -> Subida Genérica de Datos&quot;. Al finalizar este proceso se ha creado un fichero <i>&quot;factusolweb.sql&quot;</i> en la
				carpeta del servidor que se definió en las
				Configuraciones Técnicas.<br><br></li>
		</ol>
	<br><br></li>
	<li>En <b>FSx-Connector</b>:<br><br>
		<ol class="steptwo">
			<li><b>Preparar FSx-Connector.</b><br>
				Configurar los parámetros generales y las carpetas de conexión con FactuSOL (componente <b>FSx-Configuración</b>).<br><br></li>
			<li><b>Importar los Datos subidos a Internet a la Base de Datos de FactuSOLWeb.</b><br>
				Son los datos contenidos en el fichero <i>&quot;factusolweb.sql&quot;</i> (componente <b>FSx-Configuración</b>).<br><br></li>
			<li><b>Configurar FSx-Connector.</b><br>
				Establecer las equivalencias entre Impuestos y Formas de Pago (componente <b>FSx-Diccionario</b>).<br><br></li>
			<li><b>Actualizar Categorías y Productos.</b><br>
				Después de realizar este paso los datos de Secciones, Familias y
Artículos quedarán incorporados al Catálogo la Tienda Web. Se utilizan los componentes <b>FSx-Catálogo</b> y <b>FSx-LOG</b>.<br><br></li>
			<li><b>Descargar Clientes y Pedidos.</b><br>
				Al finalizar este paso se han creado varios ficheros (uno por Cliente, uno
por Pedido) en las carpetas del servidor que se definieron en las Configuraciones Técnicas de FactuSOL y FSx-Connector. 
Se utilizan los componentes <b>FSx-Pedidos</b> y <b>FSx-LOG</b>.<br><br></li>
		</ol>
	<br><br></li>
	<li>En <b>FactuSOL</b>:<br><br>
		<ol class="stepthree">
			<li><b>Descargar Clientes a FactuSOL.</b><br>
				Descargar e introducir en FactuSOL los Clientes registrados en la Tienda Web (&quot;Internet -> Descargar Clientes&quot;).<br><br></li>
			<li><b>Descargar Pedidos a FactuSOL.</b><br>
				Descargar e introducir en FactuSOL los Pedidos realizados en la Tienda Web (&quot;Internet -> Descargar Pedidos de Clientes&quot;).<br><br></li>
		</ol>
	<br><br></li>
</ol>
...
<iframe width="640" height="360" src="//www.youtube.com/embed/RMKkwq6JoxI?rel=0" frameborder="0" allowfullscreen></iframe>
