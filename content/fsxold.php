...
<h1 id="MODULE_FSXLEGACY">FSx-Connector <span class="color_h1">para PrestaShop 1.4.x y 1.3.x</span></h1>
<div class="chapter">
<!-- div class="prev"><a class="chapter" href="index.php?tab=fsx">&laquo; Anterior</a></div -->
<div class="next"><a class="chapter" href="index.php?tab=fsxoldman">Siguiente &raquo;</a></div>
</div>
<hr>
<p class="intro">Este documento es una Guía o Tutorial del Conector FSx-Connector para PrestaShop 1.4.x y 1.3.x. 
La mayoría de características se aplican también a FSx-Connector para PrestaShop 1.2.5+.</p>
<hr>

<p><img width="15" height="15" alt="lamp" src="images/lamp.gif"> Consulte el enlace: <a href="index.php?tab=fsxoldman" target="_top">FSx-Manuales</a>.</p>
<hr>
...
serán creados en FactuSOL, de forma que usted podrá realizar el proceso de
venta directamente en FactuSOL.<br><br></li>
</ul>
<hr>
